...
def evaluate(model_path):
    ...
    #model_dir = "./pd0.05_dssim0.6"
    model_dir = model_path[0]
    print(model_dir)
    #test_dir = os.path.join(model_dir, "train")
    test_dir = model_dir
    for method in os.listdir(test_dir):
        print("Method:", method)
        ...
        gt_dir = "../dataset/public_test/images"
        #renders_dir = os.path.join(method_dir, "renders")
        renders_dir = method_dir
        renders, gts, image_names = readImages(renders_dir, gt_dir)
        ...
        #print(renders)
        for idx in tqdm(range(len(renders)), desc="Metric evaluation progress"):
            #print("renders[idx] shape:", renders[idx].shape)
            #print("gts[idx] shape:", gts[idx].shape)
            ssims.append(ssim(renders[idx], gts[idx]))
            psnrs.append(psnr(renders[idx], gts[idx]))
            lpipss.append(lpips(renders[idx], gts[idx], net_type='vgg'))
    ...
    #print("per_view_dict", per_view_dict)
