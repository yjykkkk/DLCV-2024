...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_path', #./hw1_data/p1_data/pretrain_model_SL.pt
                        default='./pretrain_best.pt', type=str, help='Please enter the path of the pretrained checkpoint.')
