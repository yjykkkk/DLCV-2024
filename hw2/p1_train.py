...
if __name__ == "__main__":
    ...
    mnistm = MnistDataset(file_path='./hw2_data/digits/mnistm/data', csv_path='./hw2_data/digits/mnistm/train.csv', transform=tf)
    svhn = SVHNDataset(file_path='./hw2_data/digits/svhn/data', csv_path='./hw2_data/digits/svhn/train.csv', transform=tf)    
    dataset = ConcatDataset([mnistm, svhn])
    ...
    for ep in range(n_epoch):
        ...
        torch.save(checkpoint, os.path.join(model_path, f"model_{ep}.pth")) 
